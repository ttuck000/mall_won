...
pluralCaseList.push( {plural: "menuSearches", pascal: "MenuSearch"} )
pluralCaseList.push( {plural: "checkOederAdresses", pascal: "CheckOederAdress"} )

pluralCaseList.push( {plural: "payments", pascal: "Payment"} )

pluralCaseList.push( {plural: "foodCookings", pascal: "FoodCooking"} )

pluralCaseList.push( {plural: "deliveryOrderProcessings", pascal: "DeliveryOrderProcessing"} )
