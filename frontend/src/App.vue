        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="checkOederAdresses"
                        to="/checkOederAdresses"
                        @click="changeUrl()"
                        color="deep-purple lighten-2"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveryOrderProcessings"
                        to="/deliveryOrderProcessings"
                        @click="changeUrl()"
                        color="deep-purple lighten-2"
                        style="font-weight:700;"
                    >
                        ...
                        >
                            ...
                            <v-card-actions>
                                <v-tooltip bottom>
                                    ...
                                    <span>DeliveryOrderProcessing</span>
                                </v-tooltip>
                            </v-card-actions>
                        </v-card>
